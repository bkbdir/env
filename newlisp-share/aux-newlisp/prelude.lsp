;; Prelude
;; Stuff that is loaded into global namespace


(define foo (lambda (x) (print x)))

;;; hash.lsp --- Context base hash table
;; this functions are taken from kosh04s library "newlisp.snippet": https://github.com/kosh04/newlisp.snippet/
