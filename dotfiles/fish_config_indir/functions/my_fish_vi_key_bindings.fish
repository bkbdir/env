function my_fish_vi_key_bindings --description 'vi-like key bindings for fish'
    if contains -- -h $argv
    ...
    if test "$fish_key_bindings" != "my_fish_vi_key_bindings"
        ...
        set fish_key_bindings my_fish_vi_key_bindings
        return
    end
    ...
    bind -m insert j forward-char force-repaint
    bind -m insert J end-of-line force-repaint
    ...
    bind A end-of-line delete-char
